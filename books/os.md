...
玩游戏要用的[directx12](https://devblogs.microsoft.com/directx/directx-12-ultimate-for-holiday-2020/)，需要2060以上的显卡，不幸的是我的显卡只是1060，用不了。

操作上其实更简单了，但使用习惯有较大的变动。很多设置的操作要查资料才找的到。但新人上手会更快。

#### Hyper-V
非常好用，虽然跟vm不兼容，只能选一个使用，但我还是选了它，管理很清晰，毕竟是内置的功能。
